                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            ...
                                            <div class="text-muted pt-2 font-size-sm">List of User Management</div></h3>
                                        </div>
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search Email" id="user_management_search_query" />
                                                                <span>
                                                        ...
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <select class="form-control" id="user_management_search_role">
                                        ...
                                        <!--end: Search Form-->
                                        <!--begin: Datatable-->
                                        <table class="datatable datatable-borderless" id="user_management">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name</th>
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->roles->id }}</td>
                                                    <td>
                                                        <form method="POST" action="{{ route('user-management.delete',[$user->id]) }}">
                                                            @csrf 
                                                            @method('DELETE')
                                                            <a href="{{ route('user-management.view',[$user->id]) }}" title="Edit" class="btn btn-icon btn-light btn-sm mx-1">
