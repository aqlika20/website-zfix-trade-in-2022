                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_tv as $pte)
                                                    <tr>
                                                        ...
                                                        <td>{{ $pte->brand }}</td>
                                                        <td>{{ $pte->jenis_tv }}</td>
                                                        <td>Rp. {{ Helper::moneyFormat($pte->price) }}</td>
                                                        <td>
                                    ...
                                    <div class="tab-pane fade " id="tab_approved" role="tabpanel" aria-labelledby="tab_approved">
                                        ...
                                        <thead>
                                                ...
                                                @php
                                                    $num = 0
                                                @endphp
                                                @foreach ($process_approve as $pta)
                                                    <tr>
                                                        <td>{{ $num+=1 }}</td>
                                                        <td>{{ $pta->users->name }}</td>
                                                        <td>{{ $pta->brand }}</td>
                                                        <td>{{ $pta->jenis_tv }}</td>
                                                        <td>Rp. {{ Helper::moneyFormat($pta->price) }}</td>
                                                        <td>
                                                            <a href="{{route('tv-trade.detail', ['id' => $pta->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                                ...
                                                <div class="col-lg-9 col-xl-8">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('generate_tv_partner') }}" class="btn btn-secondary">Surat Claim</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
