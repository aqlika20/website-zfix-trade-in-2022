                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_ps as $pp)
                                                    <tr>
                                                        ...
                                                        <td>{{ $pp->type }}</td>
                                                        <td>{{ $pp->storages }}</td>
                                                        <td>Rp. {{ Helper::moneyFormat($pp->price) }}</td>
                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_approve as $pa)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('ps-trade.detail', ['id' => $pa->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        </table>
                                                ...
                                                <div class="col-lg-9 col-xl-8">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('generate_ps_partner') }}" class="btn btn-secondary">Surat Claim</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
