                                            ...
                                            <table class="datatable cell-border" id="tb_baru">
                                                ...
                                                @foreach ($process_baru as $pb)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('handphone-trade.detail', ['id' => $pb->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_hp as $pl)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('handphone-trade.detail', ['id' => $pl->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_rejected as $pr)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('handphone-trade.detail', ['id' => $pr->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                    ...
                                    <div class="tab-pane fade " id="tab_selesai" role="tabpanel" aria-labelledby="tab_selesai">
                                                ...
                                                <div class="col-lg-9 col-xl-8">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('generate_hp_partner') }}" class="btn btn-secondary">Surat Claim</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <thead>
                                                ...
                                                @php
                                                    $num = 0
                                                @endphp
                                                @foreach ($process_selesai as $pse)
                                                    <tr>
                                                        <td>{{ $num+=1 }}</td>
                                                        <td>{{ $pse->users->name }}</td>
                                                        <td>{{ $pse->brand }}</td>
                                                        <td>{{ $pse->ram }}</td>
                                                        <td>{{ $pse->storages }}</td>
                                                        <td>Rp. {{ Helper::moneyFormat($pse->price) }}</td>
                                                        <td>
                                                            <a href="{{route('handphone-trade.detail', ['id' => $pse->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
