                                    ...
                                    <div class="tab-pane fade " id="tab_proses" role="tabpanel" aria-labelledby="tab_proses">
                                        ...
                                        <thead>
                                                ...
                                                @php
                                                    $num = 0
                                                @endphp
                                                @foreach ($process_mesin_cuci as $pmc)
                                                    <tr>
                                                        <td>{{ $num+=1 }}</td>
                                                        <td>{{ $pmc->users->name }}</td>
                                                        <td>{{ $pmc->brand }}</td>
                                                        <td>{{ $pmc->type }}</td>
                                                        <td>Rp. {{ Helper::moneyFormat($pmc->price) }}</td>
                                                        <td><a href="{{route('mesin-cuci-trade.detail', ['id' => $pmc->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        </table>
                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_approve as $pa)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('mesin-cuci-trade.detail', ['id' => $pa->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        </table>
                                        ...
                                        <thead>
                                                ...
                                                @foreach ($process_selesai as $ps)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('mesin-cuci-trade.detail', ['id' => $ps->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        </table>
