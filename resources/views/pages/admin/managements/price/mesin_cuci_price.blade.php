                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Mesin Cuci Price
                                            <div class="text-muted pt-2 font-size-sm">List of Mesin Cuci</div></h3>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                            <form method='post'  action="{{ route('import.price_mesin_cuci') }}" enctype='multipart/form-data' >
                                                                {{ csrf_field() }}
