                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Televisi Price
                                            <div class="text-muted pt-2 font-size-sm">List of Televisi</div></h3>
                                        </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                            <form method='post'  action="{{ route('import.price_tv') }}" enctype='multipart/form-data' >
                                                                {{ csrf_field() }}
                                        ...
                                        <table class="datatable datatable-borderless" id="harga_ps">
                                            ...
                                            @php
                                                $num = 0
                                            @endphp
                                            @foreach ($tv_price as $tp)
                                            <tr>
                                                <td>{{ $num+=1 }}</td>
                                                <td>{{ $tp->brand }}</td>
                                                <td>{{ $tp->jenis_tv }}</td>
                                                <td>{{ $tp->inch }}</td>
                                                <td>Rp. {{ Helper::moneyFormat($tp->priceGradeA) }}</td>
                                                <td>Rp. {{ Helper::moneyFormat($tp->priceGradeB) }}</td>
                                                <td>Rp. {{ Helper::moneyFormat($tp->priceGradeC) }}</td>
                                                <!--<td>Coming Soon</td>-->
